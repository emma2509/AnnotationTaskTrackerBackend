...
class TestGetAllAnnotations:
    @patch("src.modules.annotation_table.get_record_joined_table")
...
class TestUpdateAnnotationRecord:
    ...
    headers = {"requester-user-name": "fake-name", "requester-password": "fake-pass"}
    condition_field = "annotationid"
    ...
    def test_succeed_update_regular_owner(
        ...
        mock_auth.return_value = {"statusCode": 200, "body": "regular"}
        expected_response = {"statusCode": 200, "body": "Success updating record"}
        self.headers["requester-user-name"] = "name"
